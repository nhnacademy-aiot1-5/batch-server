...
import live.ioteatime.batchserver.repository.impl.MonthlyConsumptionRepositoryImpl;
...
class MonthlyConsumptionRepositoryTest {

    @Mock
    JdbcTemplate jdbcTemplate;

    @InjectMocks
    MonthlyConsumptionRepositoryImpl repository;
